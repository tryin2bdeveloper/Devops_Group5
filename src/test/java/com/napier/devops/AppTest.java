...
class AppTest
{
    ...
    void printSuccessMessage() {
        out.println("Test executed successfully.");
    }
    ...
    void testPrintCitiesWithEmptyList() {
        ...
        App.printCities(emptyList, "Test City table with empty list", null);
        assertEquals(0, emptyList.size());
    }
    ...
    void testPrintCitiesWithData() {
        ...
        App.printCities(cities, "Test Cities table", null);
    ...
    void testGetPopulatedCountriesWithPositiveLimit() {
        ...
        out.println("#### Printing Populated Countries (Positive Limit) ####");
    ...
    void testGetPopulatedCountriesWithKeyAndValue() {
        ...
        out.println("#### Printing Populated Countries (Key: Continent, Value: Asia) ####");
    ...
    void testGetPopulatedCityWithPositiveLimit() {
        ...
        out.println("#### Printing Populated Cities (Positive Limit) ####");
    ...
    void testGetPopulatedCapitalWithPositiveLimit() {
        ...
        out.println("#### Printing Populated Capitals (Positive Limit) ####");
    ...
    void testGetPopulatedCapitalWithKeyAndValue() {
        ...
        out.println("#### Printing Populated Capitals (Key: Continent, Value: Asia) ####");
    ...
    //Test for population report output is correct or not in Detail
    @Test
    ...
    //Test for Country report output is correct or not in Detail
    @Test
    ...
    //Test city report is correct or not in Detail
    @Test
    ...
    //Test Capital report is correct or not in Detail
    @Test
    ...
    //Test Language report is correct or not in Detail
    @Test
    void testLanguage() {
